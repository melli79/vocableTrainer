...
#ifndef LECT2_PSKEL_HXX
#define LECT2_PSKEL_HXX
...
class Lect2_pskel: public ::xml_schema::complex_content {
public:
    ...
    virtual void addVoc(const Vocable &);

    virtual void post_Lect2 () {}

    Info_pskel* getInfoParser() { return info_parser_; }

    Vocable_pskel* getVocParser() { return voc_parser_; }

    // Parser construction API.
    //
    void
    info_parser(Info_pskel *);

    void
    voc_parser(Vocable_pskel *);
...
protected:
    ::Info_pskel* info_parser_;
    ::Vocable_pskel* voc_parser_;
};

class Info_pskel: public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // void pre () override;
    ...
    virtual Info post_Info () =0;

    xml_schema::string_pskel* getAuthorParser() { return author_parser_; }
    xml_schema::string_pskel* getTitleParser() { return title_parser_; }
    xml_schema::string_pskel* getMailParser() { return mail_parser_; }
    xml_schema::string_pskel* getDescriptionParser() { return description_parser_; }
    ...
    void
    mail_parser(xml_schema::string_pskel*);
...
protected:
    ...
    ::xml_schema::string_pskel* mail_parser_;
    ::xml_schema::string_pskel* description_parser_;
};

class Vocable_pskel: public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // void pre () override;

    virtual void zh (const Zh&);

    virtual void t(const QString&);

    virtual void en(const QString&);

    virtual Vocable post_Vocable () =0;

    Zh_pskel* getZhParser() { return zh_parser_; }
    // Parser construction API.
    //
    void zh_parser(Zh_pskel *);

    void t_parser(xml_schema::string_pskel *);

    void en_parser(xml_schema::string_pskel *);
...
protected:
    ::Zh_pskel* zh_parser_;
    ::xml_schema::string_pskel* t_parser_;
    ::xml_schema::string_pskel* en_parser_;
};

class Zh_pskel: public ::xml_schema::complex_content {
public:
    // Parser callbacks. Override them in your implementation.
    //
    // void pre () override;

    virtual void w(const QString&);

    virtual void r(const QString&);

    virtual Zh post_Zh () =0;

    // Parser construction API.
    //
    void
    w_parser(xml_schema::string_pskel *);

    void
    r_parser(xml_schema::string_pskel *);
...
protected:
    ::xml_schema::string_pskel* w_parser_;
    ::xml_schema::string_pskel* r_parser_;
};
